...
urlpatterns = [
    ...
    path('documentos/descargar', views.descargar_documento, name='descargar_documento'),
    ...
    path('jugadores/receso', views.jugadores_receso, name='jugadores_receso'),
    path('jugadores/receso/<int:id>/', views.enviar_jugador_receso, name='enviar_jugador_receso'),
    path('jugadores/reactivar/<int:id>/', views.reactivar_jugador, name='reactivar_jugador'),
    ...
    path('prestamos/<int:id_jugador>/', views.realizar_prestamo, name='realizar_prestamo'),
